                        ...
                        {!isLogin && (
                            <div className="flex flex-col gap-2">
                                ...
                                <input 
                                    ...
                                    className="bg-white/5 border border-white/5 rounded-full px-8 py-5 text-sm text-white placeholder-gray-700 focus:border-primary focus:outline-none transition-all focus:bg-white/10"
